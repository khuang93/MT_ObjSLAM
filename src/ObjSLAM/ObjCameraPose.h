...
//    double m20 = eigen_mat(2,0);double m21 = eigen_mat(2,1);double m22 = eigen_mat(2,2);
    ...
    eigen_mat(0,0) = se3Pose->GetR().m00;eigen_mat(0,1) = se3Pose->GetR().m01;eigen_mat(0,2) = se3Pose->GetR().m02;
    eigen_mat(1,0) = se3Pose->GetR().m10;eigen_mat(1,1) = se3Pose->GetR().m11;eigen_mat(1,2) = se3Pose->GetR().m12;
    eigen_mat(2,0) = se3Pose->GetR().m20;eigen_mat(1,1) = se3Pose->GetR().m21;eigen_mat(2,2) = se3Pose->GetR().m22;
