...
int main(int argc, char **argv) {
  ...
  internalSettings->sceneParams =ITMLib::ITMSceneParams(0.05f, 100, 0.005f, 0.1, 10.0, true);// ITMLib::ITMSceneParams(0.08f, 100, 0.008f, 0.1, 10.0, true);

  std::shared_ptr<ITMLib::ITMLibSettings> internalSettings_obj = std::make_shared<ITMLib::ITMLibSettings>();
  internalSettings_obj->sceneParams = ITMLib::ITMSceneParams(0.05f, 100, 0.005f, 0.1, 10.0, true);
