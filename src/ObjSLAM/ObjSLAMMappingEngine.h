...
//  std::vector<ObjectInstanceScene<TVoxel, TIndex> *> object_instance_scene_vector;
        ...
        std::shared_ptr<ObjectInstanceScene<TVoxel, TIndex>> *preAllocation_array;
...
//                                                                 MEMORYDEVICE_CPU);
            ...
            preAllocateObjects(number_preallocation);
