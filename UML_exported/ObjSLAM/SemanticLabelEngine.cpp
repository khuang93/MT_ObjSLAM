 ...
 * @param  semanticView
 */
virtual void InferSegmentation (ObjSLAM::SemanticView semanticView)
{
}
...
ITMUIntImage labelMask;
ObjSLAM::SemanticView semanticView;
public:
 ...
 */
void setLabelMask (ITMUIntImage new_var) {
	labelMask = new_var;
}
 ...
 */
void setSemanticView (ObjSLAM::SemanticView new_var) {
 ...
 */
ObjSLAM::SemanticView getSemanticView () {
	return semanticView;
}
private:
